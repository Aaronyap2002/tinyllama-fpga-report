...
A mixed-precision scheme using INT8 for weights and FP16 for activations, as explored in SmoothQuant \cite{xiao2023smoothquant}, would likely recover
...
sequential, since each token depends on all previous tokens, which limits the
